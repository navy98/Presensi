    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <div class="box box-solid">
        <div class="box-header with-border">
          ...
          if($level_user==1){
            echo'
            <a href="'.$mod.'&op=add" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Baru</a>';}
          else{
            echo'<button type="button" class="btn btn-success access-failed"><i class="fa fa-plus"></i> Tambah Baru</button>';
          }echo'
          
            <button class="btn btn-default" type="submit" name="cari-pegawai">Cari Pegawai</button> <!-- (Tombol Submit Pencarian -->
